...
$base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
 ...
 $base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
       ...
       // $in =InvoiceMacineDetails::where('invoice_details_number','=', $this->invoice_details_number)->get();
        return view('livewire.invoice.view-invoice',['invoice'=>$invoice,'invoice_details_number'=>$this->invoice_details_number,'image'=>$base64 ])->layout('livewire.system.template.template')->title('View Invoice');
    }
}
