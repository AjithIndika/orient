...
toastr()->success('Box attached successfully!', 'Congrats');
    ...
    public function render()
    {
      ...
      $mbox= BoxDetails::where('box_details_status','=','')->where('deliveryNote_id','=','')->get();
      $mpaddle= paddleDetails::where('paddle_details_status','=','')->where('deliveryNote_id','=','')->get();
      $miron= IronDetails::where('iron_details_status','=','')->where('deliveryNote_id','=','')->get();
      ...
      $mclist=MachinListDetails::join('machin_type_details','machin_type_details.machin_type_details_id','=','machin_list_details.machin_type_details_id')
                                ->join('machin_brand_details','machin_brand_details.machin_brand_details_id','=','machin_list_details.machin_brand_details_id')
                                ->join('machin_model_details','machin_model_details.machin_model_details_id','=','machin_list_details.machin_model_details_id')
            ->get();




      return view('livewire.machine-list.machine-list',[ 'data'=> $data,
                                                         'branch'=>$branch,
                                                         'mbrand'=>$mbrand,
                                                         'mtype'=>$mtype,
                                                         'mmodel'=>$mmodel,
                                                         ...
                                                         'miron'=>$miron,
                                                         'mclist'=>$mclist
                                                        ])->layout('livewire.system.template.template')->title('Machine List');
    }
}
