...
return new class extends Migration
{
    ...
    {
        Schema::create('delivery_machine_details', function (Blueprint $table) {
            $table->increments('delivery_machine_details_id')->unique();
    ...
    {
        Schema::dropIfExists('delivery_machine_details');
    }
};
