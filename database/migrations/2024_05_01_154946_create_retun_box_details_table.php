...
return new class extends Migration
{
    ...
    {
        Schema::create('retun_box_details', function (Blueprint $table) {
            $table->increments('retun_box_details_id')->unique();
            $table->string('retun_geatpass_details_number');
            $table->string('geatpass_details_number');
            $table->string('box_details_id');
    ...
    {
        Schema::dropIfExists('retun_box_details');
    }
};
