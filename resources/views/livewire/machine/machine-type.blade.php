<div class="" >
    ...
    <span class="feather icon-plus"></span>&nbsp;&nbsp;New Machine Type</button>
  </div>
      ...
      <div class=" bg-white col-sm-11  d-flex align-items-center justify-content-center" >
          ...
          <table class="table table-bordered m-1">
            ...
            <tbody>
              ...
              <tr>
              <td>{{$key+1}}</td>
                <td>{{$dataAll->machin_type_details_name}}</td>
                <td>{{$dataAll->machin_type_details_description}}</td>
                <td>
                  <button type="button" class="btn icon-btn  btn-outline-success" data-toggle="modal"  data-target="#showeditbranches" wire:click="Edit({{$dataAll->machin_type_details_id}})">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Add new Machin Type  </h4>
          ...
          <div class="modal-body">
              ...
              <form  >
                @csrf
                @include('livewire.machine.machine-type-from')
              </div>
    ...
    <div class="modal fade" wire:ignore.self id="showeditbranches" tabindex="-1" role="dialog" aria-labelledby="editBranch" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Edit Machin Type</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
