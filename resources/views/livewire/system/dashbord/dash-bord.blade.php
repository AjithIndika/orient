                                ...
                                <table class="table table-hover card-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media mb-0">
                                                    <img src="{{url('assets/img/avatars/3-small.png')}}" class="d-block ui-w-40 rounded-circle" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media mb-0">
                                                    <img src="{{url('assets/img/avatars/1-small.png')}}" class="d-block ui-w-40 rounded-circle" alt="">
                                                    <div class="media-body align-self-center ml-3">
