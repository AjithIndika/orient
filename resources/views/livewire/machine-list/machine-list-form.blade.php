<div>
    ...
    <input type="hidden" wire:model="machin_list_details">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select  class="form-control @error('machin_type_details')  border-danger  @enderror "  wire:model="machin_type_details" required>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select  class="form-control @error('machin_brand_details')  border-danger  @enderror "  wire:model="machin_brand_details" required>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select  class="form-control @error('machin_model_details')  border-danger  @enderror "  wire:model="machin_model_details" required>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select  class="form-control @error('box_details')  border-danger  @enderror "  wire:model="box_details">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select  class="form-control @error('paddle_details')  border-danger  @enderror "  wire:model="paddle_details">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select  class="form-control @error('iron_details')  border-danger  @enderror "  wire:model="iron_details">
                    ...
                    <div class="row">
                      <div class="col">
                          <div class="form-group">
                              ...
                              <select  class="form-control @error('branches')  border-danger  @enderror col-sm-4"  wire:model="branches" required>
                      ...
                      <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('machin_list_details_daily_rent')  border-danger  @enderror" placeholder="Daily Rent"  id="email"  wire:model="machin_list_details_daily_rent" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  required>
                  ...
                  <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control  @error('machin_list_details_note')  border-danger  @enderror" placeholder="Note"  id="email"  wire:model="machin_list_details_note" >
                            <div>
