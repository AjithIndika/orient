                ...
                <div id="login">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <fieldset class="clearfix">
                            ...
                            <p><span class="fa fa-user"></span><input class=" @error('email') is-invalid @enderror"
                                    name="email" type="text" Placeholder="Username" required>
                                @error('email')
                            ...
                            <p><span class="fa fa-lock"></span><input class="@error('password') is-invalid @enderror"
