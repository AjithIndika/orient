...
<body>
    <section class="wrapper-invoice">
        ...
        <?php
        $invo = json_decode($mailData['invoice']);
        ...
        <div class="invoice">
            ...
            <div class="invoice-logo-brand">
                <!-- <h2>Tampsh.</h2> -->
                <img src="https://system.orientsewingmachine.lk/image-system/sw.png" alt="" />
            </div>
            <!-- invoice head -->
            <div class="invoice-head">
                <div class="head client-info">
                    ...
                    <p>{{ $invo->invoice_details_customer_number }}</p>
